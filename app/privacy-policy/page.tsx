        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="border-l-4 border-accent-500 pl-6">
              <h1 className="heading-lg text-navy-50 mb-3">Privacy Policy</h1>
          ...
          <div className="glass-card p-8 sm:p-12">
            ...
            <section className="mb-12 pb-8 border-b border-navy-700/50">
              ...
              <div className="ml-16">
                <h3 className="text-2xl font-semibold text-navy-50 mb-4 mt-6">2.1 Personal Information</h3>
                ...
                <ul className="list-disc pl-6 mb-6 space-y-3 text-navy-200 text-base">
                ...
                <h3 className="text-2xl font-semibold text-navy-50 mb-4 mt-8">2.2 Financial Information</h3>
                <p className="text-navy-200 leading-relaxed mb-4 text-base">
                ...
                <h3 className="text-2xl font-semibold text-navy-50 mb-4 mt-8">2.3 Automatically Collected Information</h3>
                <p className="text-navy-200 leading-relaxed mb-4 text-base">
                  When you access our Service, we automatically collect certain information, including:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-3 text-navy-200 text-base">
            ...
            <section className="mb-12 pb-8 border-b border-navy-700/50">
              ...
              <div className="ml-16 space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-navy-50 mb-4">4.1 Service Providers</h3>
                  <p className="text-navy-200 leading-relaxed mb-4 text-base">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-navy-50 mb-4">4.2 Lenders and Financial Partners</h3>
                  <p className="text-navy-200 leading-relaxed text-base">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-navy-50 mb-4">4.3 Legal Requirements</h3>
                  <p className="text-navy-200 leading-relaxed mb-4 text-base">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-navy-50 mb-4">4.4 Business Transfers</h3>
                  <p className="text-navy-200 leading-relaxed text-base">
            ...
            <section className="mb-12 pb-8 border-b border-navy-700/50">
              ...
              <div className="ml-16">
                ...
                <div className="glass-card p-8 rounded-xl">
                  ...
                  <p className="text-navy-200 mb-2 text-base">Email: <a href="mailto:privacy@alnex.ai" className="text-accent-400 hover:underline">privacy@alnex.ai</a></p>
